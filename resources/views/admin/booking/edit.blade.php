...
<div class="edit-container">
    <div style="text-align: center; margin-bottom: 30px;">
        <h2 style="font-weight: 800; font-size: 30px;">Edit <span style="color:var(--primary)">Booking #{{ $booking->kode_booking }}</span></h2>
    ...
    <form action="{{ route('admin.booking.update', $booking->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <div class="input-wrapper" style="position: relative;">
                {{-- Jika terkunci, kita tambahkan input hidden karena select disabled tidak mengirim data ke server --}}
                @if($isLocked)
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                ...
                <small id="nominal_potongan" class="text-success" style="font-size: 11px; font-weight: 700; margin-top: 8px; display: block;">
                    Potongan: Rp 0
                </small>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Event listener saat input diskon berubah
        inputDiskon.addEventListener('input', calculateDiscount);

        // Jalankan sekali saat load untuk sinkronisasi data awal
        calculateDiscount();
    });
</script>
@endsection
