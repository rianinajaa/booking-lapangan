...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <a href="{{ route('admin.dashboard') }}" class="sidebar-logo">
            <div class="logo-icon">
                <svg width="18" height="18" fill="none" stroke="#0f1621" stroke-width="2.5"
                    viewBox="0 0 24 24">
        ...
        <div style="flex:1; overflow-y:auto; padding:8px 0;">
            ...
            <a href="{{ route('admin.booking.index') }}"
                ...
                @if ($pb > 0)
                    <span
                        style="margin-left:auto; background:var(--green); color:#0f1621; font-size:10px; font-weight:700; min-width:18px; height:18px; border-radius:99px; display:flex; align-items:center; justify-content:center; padding:0 5px;">{{ $pb }}</span>
                @endif
            </a>
            ...
            <a href="{{ route('admin.pembayaran.index') }}"
                ...
                @if ($pp > 0)
                    <span
                        style="margin-left:auto; background:var(--danger); color:white; font-size:10px; font-weight:700; min-width:18px; height:18px; border-radius:99px; display:flex; align-items:center; justify-content:center; padding:0 5px;">{{ $pp }}</span>
                @endif
            </a>
    ...
    <header class="topbar">
        ...
        <button onclick="openSidebar()"
            style="display:none; background:none; border:none; color:var(--text-2); font-size:18px; cursor:pointer; margin-right:8px;"
            id="hamburger">
    ...
    ">
                ...
                <div id="searchEmpty"
                    ...
                    <i class="fa-solid fa-magnifying-glass"
                        style="font-size:20px; opacity:0.3; display:block; margin-bottom:8px;"></i>
                    Tidak ada hasil untuk "<span id="searchEmptyQuery"></span>"
                </div>
            </div>
        </div>
        ...
        <script>
            (function() {
                ...
                const emptyQ = document.getElementById('searchEmptyQuery');
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-100"
                    ...
                    <div class="border-t border-[rgba(255,255,255,0.07)] py-1 bg-[rgba(239,68,68,0.02)]">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit"
                                class="w-full flex items-center gap-3 px-4 py-2.5 text-[13px] text-red-400 hover:bg-[rgba(239,68,68,0.1)] transition-all">
    ...
    <main class="main">
        ...
        @hasSection('breadcrumb')
            <div class="breadcrumb">
                <a href="{{ route('admin.dashboard') }}"><i class="fa-solid fa-house"
